(function(){
    ...
    GameCenterExtension.prototype = {
        ...
        getSocialInterface: function() {
            if (!this._socialService) {
                this._socialService = new SocialGameCenter(this);
            }
    ...
    CocoonJS.Social.GameCenter = new GameCenterExtension();
    ...
    CocoonJS.Social.GameCenter.Leaderboard = function(category, playerIDs, timeScope, playerScope, rangeStart, rangeLength) {
         ...
         * @type Array of CocoonJS.SocialGameCenter.Score
         */
        this.scores = [];
        /**
         * Local player score (response parameter)
         * @type CocoonJS.SocialGameCenter.Score
         */
    ...
    function SocialGameCenter(gcExtension) {
        SocialGameCenter.superclass.constructor.call(this);
        this.gc = gcExtension;
        var me = this;
    ...
    CocoonJS.extend(SocialGameCenter, CocoonJS.Social.SocialGamingService);
