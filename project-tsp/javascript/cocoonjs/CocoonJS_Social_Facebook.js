(function() {
    ...
    function FacebookExtension(){
        ...
        this.Event = new FacebookEvent(this.nativeExtensionObjectAvailable);
    ...
    /**
     *  Facebook Extension prototype. It's API is similar to the official Facebook JavaScript SDK.
     */
    FacebookExtension.prototype = {
        ...
        getSocialInterface: function() {
            ...
            if (!this._socialService) {
                this._socialService = new SocialFacebook(this);
            }
     ...
     * @constructor
     */
    function FacebookEvent(nativeAvailable ) {
        this.nativeExtensionObjectAvailable = nativeAvailable;
        return this;
    }

    FacebookEvent.prototype = {
        /**
    ...
    CocoonJS.Social.Facebook = new FacebookExtension();
    ...
    function SocialFacebook(fbExtension) {
        SocialFacebook.superclass.constructor.call(this);
        this.fb = fbExtension;
        var me = this;
            ...
            this.prepareAchievements(false, function(allAchievements, error){
                ...
                me.fb.api(apiCall, function(response) {
                    if (!response.error) {
                        ...
                        if (response.data) {
                            for (var i = 0; i < response.data.length; i++) {
                                var ach = me.findAchievement(response.data[i].achievement.id);
                                if (ach)
    ...
    CocoonJS.extend(SocialFacebook, CocoonJS.Social.SocialGamingService);
